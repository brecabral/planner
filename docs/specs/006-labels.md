...
- RN01: label tem identidade, proprietário e nome textual não vazio após remover espaços nas extremidades. Listar apenas labels do usuário autenticado; associar pelo ID, não pelo texto.
...
- CA-006-04: A informa label de B ou inexistente; operação falha sem revelar o catálogo de B ou criar registros parciais.
